...
class $DiaryEntriesTable extends DiaryEntries
  ...
  static const VerificationMeta _pageCanvasMeta = const VerificationMeta(
    'pageCanvas',
  );
  @override
  late final GeneratedColumn<String> pageCanvas = GeneratedColumn<String>(
    'page_canvas',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _flowPhotosMeta = const VerificationMeta(
    'flowPhotos',
  );
  @override
  late final GeneratedColumn<String> flowPhotos = GeneratedColumn<String>(
    'flow_photos',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _photoFramesMeta = const VerificationMeta(
    'photoFrames',
  );
  @override
  late final GeneratedColumn<String> photoFrames = GeneratedColumn<String>(
    'photo_frames',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _photoStickersMeta = const VerificationMeta(
    'photoStickers',
  );
  @override
  late final GeneratedColumn<String> photoStickers = GeneratedColumn<String>(
    'photo_stickers',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _photoMemosMeta = const VerificationMeta(
    'photoMemos',
  );
  @override
  late final GeneratedColumn<String> photoMemos = GeneratedColumn<String>(
    'photo_memos',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _photoAspectsMeta = const VerificationMeta(
    'photoAspects',
  );
  @override
  late final GeneratedColumn<String> photoAspects = GeneratedColumn<String>(
    'photo_aspects',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _photoFiltersMeta = const VerificationMeta(
    'photoFilters',
  );
  @override
  late final GeneratedColumn<String> photoFilters = GeneratedColumn<String>(
    'photo_filters',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _photoCropsMeta = const VerificationMeta(
    'photoCrops',
  );
  @override
  late final GeneratedColumn<String> photoCrops = GeneratedColumn<String>(
    'photo_crops',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('page_canvas')) {
      context.handle(
        _pageCanvasMeta,
        pageCanvas.isAcceptableOrUnknown(data['page_canvas']!, _pageCanvasMeta),
      );
    }
    if (data.containsKey('flow_photos')) {
      context.handle(
        _flowPhotosMeta,
        flowPhotos.isAcceptableOrUnknown(data['flow_photos']!, _flowPhotosMeta),
      );
    }
    if (data.containsKey('photo_frames')) {
      context.handle(
        _photoFramesMeta,
        photoFrames.isAcceptableOrUnknown(
          data['photo_frames']!,
          _photoFramesMeta,
        ),
      );
    }
    if (data.containsKey('photo_stickers')) {
      context.handle(
        _photoStickersMeta,
        photoStickers.isAcceptableOrUnknown(
          data['photo_stickers']!,
          _photoStickersMeta,
        ),
      );
    ...
    if (data.containsKey('photo_memos')) {
      context.handle(
        _photoMemosMeta,
        photoMemos.isAcceptableOrUnknown(data['photo_memos']!, _photoMemosMeta),
      );
    }
    if (data.containsKey('photo_aspects')) {
      context.handle(
        _photoAspectsMeta,
        photoAspects.isAcceptableOrUnknown(
          data['photo_aspects']!,
          _photoAspectsMeta,
        ),
      );
    }
    if (data.containsKey('photo_filters')) {
      context.handle(
        _photoFiltersMeta,
        photoFilters.isAcceptableOrUnknown(
          data['photo_filters']!,
          _photoFiltersMeta,
        ),
      );
    }
    if (data.containsKey('photo_crops')) {
      context.handle(
        _photoCropsMeta,
        photoCrops.isAcceptableOrUnknown(data['photo_crops']!, _photoCropsMeta),
      );
    }
  ...
  DiaryEntryRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DiaryEntryRow(
      ...
      pageCanvas: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}page_canvas'],
      ),
      flowPhotos: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}flow_photos'],
      ),
      photoFrames: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}photo_frames'],
      ),
      photoStickers: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
      ...
      photoMemos: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}photo_memos'],
      ),
      photoAspects: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}photo_aspects'],
      ),
      photoFilters: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}photo_filters'],
      ),
      photoCrops: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}photo_crops'],
      ),
...
class DiaryEntryRow extends DataClass implements Insertable<DiaryEntryRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || pageCanvas != null) {
      map['page_canvas'] = Variable<String>(pageCanvas);
    }
    if (!nullToAbsent || flowPhotos != null) {
      map['flow_photos'] = Variable<String>(flowPhotos);
    }
    if (!nullToAbsent || photoFrames != null) {
      map['photo_frames'] = Variable<String>(photoFrames);
    }
    ...
    if (!nullToAbsent || photoMemos != null) {
      map['photo_memos'] = Variable<String>(photoMemos);
    }
    if (!nullToAbsent || photoAspects != null) {
      map['photo_aspects'] = Variable<String>(photoAspects);
    }
    if (!nullToAbsent || photoFilters != null) {
      map['photo_filters'] = Variable<String>(photoFilters);
    }
    if (!nullToAbsent || photoCrops != null) {
      map['photo_crops'] = Variable<String>(photoCrops);
    }
  ...
  DiaryEntriesCompanion toCompanion(bool nullToAbsent) {
    return DiaryEntriesCompanion(
      ...
      pageCanvas: pageCanvas == null && nullToAbsent
          ? const Value.absent()
          : Value(pageCanvas),
      flowPhotos: flowPhotos == null && nullToAbsent
          ? const Value.absent()
          : Value(flowPhotos),
      photoFrames: photoFrames == null && nullToAbsent
          ? const Value.absent()
          : Value(photoFrames),
      ...
      photoTapes: photoTapes == null && nullToAbsent
          ? const Value.absent()
          : Value(photoTapes),
      photoMemos: photoMemos == null && nullToAbsent
          ? const Value.absent()
          : Value(photoMemos),
      photoAspects: photoAspects == null && nullToAbsent
          ? const Value.absent()
          : Value(photoAspects),
      photoFilters: photoFilters == null && nullToAbsent
          ? const Value.absent()
          : Value(photoFilters),
      photoCrops: photoCrops == null && nullToAbsent
          ? const Value.absent()
          : Value(photoCrops),
  ...
  factory DiaryEntryRow.fromJson(
    ...
    return DiaryEntryRow(
      ...
      photoMemos: serializer.fromJson<String?>(json['photoMemos']),
      photoAspects: serializer.fromJson<String?>(json['photoAspects']),
      photoFilters: serializer.fromJson<String?>(json['photoFilters']),
      photoCrops: serializer.fromJson<String?>(json['photoCrops']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'photoMemos': serializer.toJson<String?>(photoMemos),
      'photoAspects': serializer.toJson<String?>(photoAspects),
      'photoFilters': serializer.toJson<String?>(photoFilters),
      'photoCrops': serializer.toJson<String?>(photoCrops),
  ...
  DiaryEntryRow copyWith({
    ...
    Value<String?> photoMemos = const Value.absent(),
    Value<String?> photoAspects = const Value.absent(),
    Value<String?> photoFilters = const Value.absent(),
    Value<String?> photoCrops = const Value.absent(),
    bool? isFavorite,
    ...
    flowPhotos: flowPhotos.present ? flowPhotos.value : this.flowPhotos,
    photoFrames: photoFrames.present ? photoFrames.value : this.photoFrames,
    photoStickers: photoStickers.present
        ? photoStickers.value
        : this.photoStickers,
    photoTapes: photoTapes.present ? photoTapes.value : this.photoTapes,
    photoMemos: photoMemos.present ? photoMemos.value : this.photoMemos,
    photoAspects: photoAspects.present ? photoAspects.value : this.photoAspects,
    photoFilters: photoFilters.present ? photoFilters.value : this.photoFilters,
    photoCrops: photoCrops.present ? photoCrops.value : this.photoCrops,
  ...
  DiaryEntryRow copyWithCompanion(DiaryEntriesCompanion data) {
    return DiaryEntryRow(
      ...
      pageCanvas: data.pageCanvas.present
          ? data.pageCanvas.value
          : this.pageCanvas,
      flowPhotos: data.flowPhotos.present
          ? data.flowPhotos.value
          : this.flowPhotos,
      photoFrames: data.photoFrames.present
          ? data.photoFrames.value
          : this.photoFrames,
      ...
      photoTapes: data.photoTapes.present
          ...
          : this.photoTapes,
      photoMemos: data.photoMemos.present
          ? data.photoMemos.value
          : this.photoMemos,
      photoAspects: data.photoAspects.present
          ? data.photoAspects.value
          : this.photoAspects,
      photoFilters: data.photoFilters.present
          ? data.photoFilters.value
          : this.photoFilters,
      photoCrops: data.photoCrops.present
          ? data.photoCrops.value
          : this.photoCrops,
  ...
  String toString() {
    return (StringBuffer('DiaryEntryRow(')
          ...
          ..write('photoMemos: $photoMemos, ')
          ..write('photoAspects: $photoAspects, ')
          ..write('photoFilters: $photoFilters, ')
          ..write('photoCrops: $photoCrops, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is DiaryEntryRow &&
          ...
          other.photoMemos == this.photoMemos &&
          other.photoAspects == this.photoAspects &&
          other.photoFilters == this.photoFilters &&
          other.photoCrops == this.photoCrops &&
...
class DiaryEntriesCompanion extends UpdateCompanion<DiaryEntryRow> {
  ...
  final Value<String?> photoMemos;
  final Value<String?> photoAspects;
  final Value<String?> photoFilters;
  final Value<String?> photoCrops;
  ...
  const DiaryEntriesCompanion({
    ...
    this.photoMemos = const Value.absent(),
    this.photoAspects = const Value.absent(),
    this.photoFilters = const Value.absent(),
    this.photoCrops = const Value.absent(),
  ...
  static Insertable<DiaryEntryRow> custom({
    ...
    Expression<String>? photoMemos,
    Expression<String>? photoAspects,
    Expression<String>? photoFilters,
    Expression<String>? photoCrops,
    ...
    return RawValuesInsertable({
      ...
      if (photoMemos != null) 'photo_memos': photoMemos,
      if (photoAspects != null) 'photo_aspects': photoAspects,
      if (photoFilters != null) 'photo_filters': photoFilters,
      if (photoCrops != null) 'photo_crops': photoCrops,
  ...
  DiaryEntriesCompanion copyWith({
    ...
    Value<String?>? photoMemos,
    Value<String?>? photoAspects,
    Value<String?>? photoFilters,
    Value<String?>? photoCrops,
    ...
    return DiaryEntriesCompanion(
      ...
      photoMemos: photoMemos ?? this.photoMemos,
      photoAspects: photoAspects ?? this.photoAspects,
      photoFilters: photoFilters ?? this.photoFilters,
      photoCrops: photoCrops ?? this.photoCrops,
      isFavorite: isFavorite ?? this.isFavorite,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pageCanvas.present) {
      map['page_canvas'] = Variable<String>(pageCanvas.value);
    }
    if (flowPhotos.present) {
      map['flow_photos'] = Variable<String>(flowPhotos.value);
    }
    if (photoFrames.present) {
      map['photo_frames'] = Variable<String>(photoFrames.value);
    }
    ...
    if (photoMemos.present) {
      map['photo_memos'] = Variable<String>(photoMemos.value);
    }
    if (photoAspects.present) {
      map['photo_aspects'] = Variable<String>(photoAspects.value);
    }
    if (photoFilters.present) {
      map['photo_filters'] = Variable<String>(photoFilters.value);
    }
    if (photoCrops.present) {
      map['photo_crops'] = Variable<String>(photoCrops.value);
    }
...
class $JournalsTable extends Journals
  ...
  static const VerificationMeta _coverBindingMeta = const VerificationMeta(
    'coverBinding',
  );
  @override
  late final GeneratedColumn<String> coverBinding = GeneratedColumn<String>(
    'cover_binding',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _coverCornerMeta = const VerificationMeta(
    'coverCorner',
  );
  @override
  late final GeneratedColumn<String> coverCorner = GeneratedColumn<String>(
    'cover_corner',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _coverBandMeta = const VerificationMeta(
    'coverBand',
  );
  @override
  late final GeneratedColumn<String> coverBand = GeneratedColumn<String>(
    'cover_band',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _coverRibbonMeta = const VerificationMeta(
    'coverRibbon',
  );
  @override
  late final GeneratedColumn<String> coverRibbon = GeneratedColumn<String>(
    'cover_ribbon',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _coverClipMeta = const VerificationMeta(
    'coverClip',
  );
  @override
  late final GeneratedColumn<String> coverClip = GeneratedColumn<String>(
    'cover_clip',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _coverTabMeta = const VerificationMeta(
    'coverTab',
  );
  @override
  late final GeneratedColumn<String> coverTab = GeneratedColumn<String>(
    'cover_tab',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _coverTextureMeta = const VerificationMeta(
    'coverTexture',
  );
  @override
  late final GeneratedColumn<String> coverTexture = GeneratedColumn<String>(
    'cover_texture',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _coverFontMeta = const VerificationMeta(
    'coverFont',
  );
  @override
  late final GeneratedColumn<String> coverFont = GeneratedColumn<String>(
    'cover_font',
    aliasedName,
    false,
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('pretendard'),
  );
  static const VerificationMeta _innerPaperMeta = const VerificationMeta(
    'innerPaper',
  );
  @override
  late final GeneratedColumn<String> innerPaper = GeneratedColumn<String>(
    'inner_paper',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('cover_binding')) {
      context.handle(
        _coverBindingMeta,
        coverBinding.isAcceptableOrUnknown(
          data['cover_binding']!,
          _coverBindingMeta,
        ),
      );
    }
    if (data.containsKey('cover_corner')) {
      context.handle(
        _coverCornerMeta,
        coverCorner.isAcceptableOrUnknown(
          data['cover_corner']!,
          _coverCornerMeta,
        ),
      );
    }
    if (data.containsKey('cover_band')) {
      context.handle(
        _coverBandMeta,
        coverBand.isAcceptableOrUnknown(data['cover_band']!, _coverBandMeta),
      );
    }
    if (data.containsKey('cover_ribbon')) {
      context.handle(
        _coverRibbonMeta,
        coverRibbon.isAcceptableOrUnknown(
          data['cover_ribbon']!,
          _coverRibbonMeta,
        ),
      );
    }
    if (data.containsKey('cover_clip')) {
      context.handle(
        _coverClipMeta,
        coverClip.isAcceptableOrUnknown(data['cover_clip']!, _coverClipMeta),
      );
    }
    if (data.containsKey('cover_tab')) {
      context.handle(
        _coverTabMeta,
        coverTab.isAcceptableOrUnknown(data['cover_tab']!, _coverTabMeta),
      );
    }
    if (data.containsKey('cover_texture')) {
      context.handle(
        _coverTextureMeta,
        coverTexture.isAcceptableOrUnknown(
          data['cover_texture']!,
          _coverTextureMeta,
        ),
      );
    }
    if (data.containsKey('cover_font')) {
      context.handle(
        _coverFontMeta,
        coverFont.isAcceptableOrUnknown(data['cover_font']!, _coverFontMeta),
      );
    }
    if (data.containsKey('inner_paper')) {
      context.handle(
        _innerPaperMeta,
  ...
  JournalRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return JournalRow(
      ...
      coverBinding: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_binding'],
      )!,
      coverCorner: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_corner'],
      )!,
      coverBand: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_band'],
      )!,
      coverRibbon: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_ribbon'],
      )!,
      coverClip: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_clip'],
      )!,
      coverTab: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_tab'],
      )!,
      coverTexture: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_texture'],
      )!,
      coverFont: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cover_font'],
      )!,
      innerPaper: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class JournalRow extends DataClass implements Insertable<JournalRow> {
  ...
  const JournalRow({
    ...
    required this.coverBinding,
    required this.coverCorner,
    required this.coverBand,
    required this.coverRibbon,
    required this.coverClip,
    required this.coverTab,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['cover_binding'] = Variable<String>(coverBinding);
    map['cover_corner'] = Variable<String>(coverCorner);
    map['cover_band'] = Variable<String>(coverBand);
    map['cover_ribbon'] = Variable<String>(coverRibbon);
    map['cover_clip'] = Variable<String>(coverClip);
    map['cover_tab'] = Variable<String>(coverTab);
  ...
  JournalsCompanion toCompanion(bool nullToAbsent) {
    return JournalsCompanion(
      ...
      coverBinding: Value(coverBinding),
      coverCorner: Value(coverCorner),
      coverBand: Value(coverBand),
      coverRibbon: Value(coverRibbon),
      coverClip: Value(coverClip),
      coverTab: Value(coverTab),
  ...
  factory JournalRow.fromJson(
    ...
    return JournalRow(
      ...
      coverBinding: serializer.fromJson<String>(json['coverBinding']),
      coverCorner: serializer.fromJson<String>(json['coverCorner']),
      coverBand: serializer.fromJson<String>(json['coverBand']),
      coverRibbon: serializer.fromJson<String>(json['coverRibbon']),
      coverClip: serializer.fromJson<String>(json['coverClip']),
      coverTab: serializer.fromJson<String>(json['coverTab']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'coverBinding': serializer.toJson<String>(coverBinding),
      'coverCorner': serializer.toJson<String>(coverCorner),
      'coverBand': serializer.toJson<String>(coverBand),
      'coverRibbon': serializer.toJson<String>(coverRibbon),
      'coverClip': serializer.toJson<String>(coverClip),
      'coverTab': serializer.toJson<String>(coverTab),
  ...
  JournalRow copyWithCompanion(JournalsCompanion data) {
    return JournalRow(
      ...
      coverPattern: data.coverPattern.present
          ...
          : this.coverPattern,
      coverBinding: data.coverBinding.present
          ? data.coverBinding.value
          : this.coverBinding,
      coverCorner: data.coverCorner.present
          ? data.coverCorner.value
          : this.coverCorner,
      coverBand: data.coverBand.present ? data.coverBand.value : this.coverBand,
      coverRibbon: data.coverRibbon.present
          ? data.coverRibbon.value
          : this.coverRibbon,
      coverClip: data.coverClip.present ? data.coverClip.value : this.coverClip,
      coverTab: data.coverTab.present ? data.coverTab.value : this.coverTab,
      coverTexture: data.coverTexture.present
          ? data.coverTexture.value
          : this.coverTexture,
      coverFont: data.coverFont.present ? data.coverFont.value : this.coverFont,
  ...
  String toString() {
    return (StringBuffer('JournalRow(')
          ...
          ..write('coverBinding: $coverBinding, ')
          ..write('coverCorner: $coverCorner, ')
          ..write('coverBand: $coverBand, ')
          ..write('coverRibbon: $coverRibbon, ')
          ..write('coverClip: $coverClip, ')
          ..write('coverTab: $coverTab, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is JournalRow &&
          ...
          other.coverBinding == this.coverBinding &&
          other.coverCorner == this.coverCorner &&
          other.coverBand == this.coverBand &&
          other.coverRibbon == this.coverRibbon &&
          other.coverClip == this.coverClip &&
          other.coverTab == this.coverTab &&
...
class JournalsCompanion extends UpdateCompanion<JournalRow> {
  ...
  final Value<String> coverBinding;
  final Value<String> coverCorner;
  final Value<String> coverBand;
  final Value<String> coverRibbon;
  final Value<String> coverClip;
  final Value<String> coverTab;
  ...
  const JournalsCompanion({
    ...
    this.coverBinding = const Value.absent(),
    this.coverCorner = const Value.absent(),
    this.coverBand = const Value.absent(),
    this.coverRibbon = const Value.absent(),
    this.coverClip = const Value.absent(),
    this.coverTab = const Value.absent(),
  ...
  static Insertable<JournalRow> custom({
    ...
    Expression<String>? coverBinding,
    Expression<String>? coverCorner,
    Expression<String>? coverBand,
    Expression<String>? coverRibbon,
    Expression<String>? coverClip,
    Expression<String>? coverTab,
    ...
    return RawValuesInsertable({
      ...
      if (coverBinding != null) 'cover_binding': coverBinding,
      if (coverCorner != null) 'cover_corner': coverCorner,
      if (coverBand != null) 'cover_band': coverBand,
      if (coverRibbon != null) 'cover_ribbon': coverRibbon,
      if (coverClip != null) 'cover_clip': coverClip,
      if (coverTab != null) 'cover_tab': coverTab,
  ...
  JournalsCompanion copyWith({
    ...
    Value<String>? coverBinding,
    Value<String>? coverCorner,
    Value<String>? coverBand,
    Value<String>? coverRibbon,
    Value<String>? coverClip,
    Value<String>? coverTab,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (coverBinding.present) {
      map['cover_binding'] = Variable<String>(coverBinding.value);
    }
    if (coverCorner.present) {
      map['cover_corner'] = Variable<String>(coverCorner.value);
    }
    if (coverBand.present) {
      map['cover_band'] = Variable<String>(coverBand.value);
    }
    if (coverRibbon.present) {
      map['cover_ribbon'] = Variable<String>(coverRibbon.value);
    }
    if (coverClip.present) {
      map['cover_clip'] = Variable<String>(coverClip.value);
    }
    if (coverTab.present) {
      map['cover_tab'] = Variable<String>(coverTab.value);
    }
    if (coverTexture.present) {
      map['cover_texture'] = Variable<String>(coverTexture.value);
    }
    if (coverFont.present) {
      map['cover_font'] = Variable<String>(coverFont.value);
    }
...
class $$DiaryEntriesTableFilterComposer
  ...
  ColumnFilters<String> get pageCanvas => $composableBuilder(
    column: $table.pageCanvas,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get flowPhotos => $composableBuilder(
    column: $table.flowPhotos,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get photoFrames => $composableBuilder(
    column: $table.photoFrames,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<String> get photoMemos => $composableBuilder(
    column: $table.photoMemos,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get photoAspects => $composableBuilder(
    column: $table.photoAspects,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get photoFilters => $composableBuilder(
    column: $table.photoFilters,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get photoCrops => $composableBuilder(
    column: $table.photoCrops,
    builder: (column) => ColumnFilters(column),
  );
...
class $$DiaryEntriesTableOrderingComposer
  ...
  ColumnOrderings<String> get pageCanvas => $composableBuilder(
    column: $table.pageCanvas,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get flowPhotos => $composableBuilder(
    column: $table.flowPhotos,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get photoFrames => $composableBuilder(
    column: $table.photoFrames,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get photoStickers => $composableBuilder(
    column: $table.photoStickers,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<String> get photoMemos => $composableBuilder(
    column: $table.photoMemos,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get photoAspects => $composableBuilder(
    column: $table.photoAspects,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get photoFilters => $composableBuilder(
    column: $table.photoFilters,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get photoCrops => $composableBuilder(
    column: $table.photoCrops,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$DiaryEntriesTableAnnotationComposer
  ...
  GeneratedColumn<String> get pageCanvas => $composableBuilder(
    column: $table.pageCanvas,
    builder: (column) => column,
  );

  GeneratedColumn<String> get flowPhotos => $composableBuilder(
    column: $table.flowPhotos,
    builder: (column) => column,
  );

  GeneratedColumn<String> get photoFrames => $composableBuilder(
    column: $table.photoFrames,
    builder: (column) => column,
  );

  GeneratedColumn<String> get photoStickers => $composableBuilder(
    column: $table.photoStickers,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<String> get photoMemos => $composableBuilder(
    column: $table.photoMemos,
    builder: (column) => column,
  );

  GeneratedColumn<String> get photoAspects => $composableBuilder(
    column: $table.photoAspects,
    builder: (column) => column,
  );

  GeneratedColumn<String> get photoFilters => $composableBuilder(
    column: $table.photoFilters,
    builder: (column) => column,
  );

  GeneratedColumn<String> get photoCrops => $composableBuilder(
    column: $table.photoCrops,
    builder: (column) => column,
  );
...
class $$JournalsTableFilterComposer
  ...
  ColumnFilters<String> get coverBinding => $composableBuilder(
    column: $table.coverBinding,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get coverCorner => $composableBuilder(
    column: $table.coverCorner,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get coverBand => $composableBuilder(
    column: $table.coverBand,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get coverRibbon => $composableBuilder(
    column: $table.coverRibbon,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get coverClip => $composableBuilder(
    column: $table.coverClip,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get coverTab => $composableBuilder(
    column: $table.coverTab,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get coverTexture => $composableBuilder(
    column: $table.coverTexture,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get coverFont => $composableBuilder(
    column: $table.coverFont,
    builder: (column) => ColumnFilters(column),
  );
...
class $$JournalsTableOrderingComposer
  ...
  ColumnOrderings<String> get coverBinding => $composableBuilder(
    column: $table.coverBinding,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get coverCorner => $composableBuilder(
    column: $table.coverCorner,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get coverBand => $composableBuilder(
    column: $table.coverBand,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get coverRibbon => $composableBuilder(
    column: $table.coverRibbon,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get coverClip => $composableBuilder(
    column: $table.coverClip,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get coverTab => $composableBuilder(
    column: $table.coverTab,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get coverTexture => $composableBuilder(
    column: $table.coverTexture,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get coverFont => $composableBuilder(
    column: $table.coverFont,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get innerPaper => $composableBuilder(
    column: $table.innerPaper,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$JournalsTableAnnotationComposer
  ...
  GeneratedColumn<String> get coverBinding => $composableBuilder(
    column: $table.coverBinding,
    builder: (column) => column,
  );

  GeneratedColumn<String> get coverCorner => $composableBuilder(
    column: $table.coverCorner,
    builder: (column) => column,
  );

  GeneratedColumn<String> get coverBand =>
      $composableBuilder(column: $table.coverBand, builder: (column) => column);

  GeneratedColumn<String> get coverRibbon => $composableBuilder(
    column: $table.coverRibbon,
    builder: (column) => column,
  );

  GeneratedColumn<String> get coverClip =>
      $composableBuilder(column: $table.coverClip, builder: (column) => column);

  GeneratedColumn<String> get coverTab =>
      $composableBuilder(column: $table.coverTab, builder: (column) => column);

  GeneratedColumn<String> get coverTexture => $composableBuilder(
    column: $table.coverTexture,
    builder: (column) => column,
  );

  GeneratedColumn<String> get coverFont =>
      $composableBuilder(column: $table.coverFont, builder: (column) => column);

  GeneratedColumn<String> get innerPaper => $composableBuilder(
    column: $table.innerPaper,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> coverBinding = const Value.absent(),
                Value<String> coverCorner = const Value.absent(),
                Value<String> coverBand = const Value.absent(),
                Value<String> coverRibbon = const Value.absent(),
                Value<String> coverClip = const Value.absent(),
                Value<String> coverTab = const Value.absent(),
