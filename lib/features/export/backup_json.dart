...
Map<String, dynamic> _entryToJson(DiaryEntry e) => {
      ...
      if (e.flowPhotos != null) 'flowPhotos': e.flowPhotos,
      if (e.photoFrames != null) 'photoFrames': e.photoFrames,
      if (e.photoStickers != null) 'photoStickers': e.photoStickers,
      if (e.photoTapes != null) 'photoTapes': e.photoTapes,
      if (e.photoMemos != null) 'photoMemos': e.photoMemos,
      if (e.photoAspects != null) 'photoAspects': e.photoAspects,
      if (e.photoFilters != null) 'photoFilters': e.photoFilters,
      if (e.photoCrops != null) 'photoCrops': e.photoCrops,
...
DiaryEntry _entryFromJson(Map<String, dynamic> m) {
  return DiaryEntry(
    ...
    flowPhotos: m['flowPhotos'] as String?,
    photoFrames: m['photoFrames'] as String?,
    photoStickers: m['photoStickers'] as String?,
    photoTapes: m['photoTapes'] as String?,
    photoMemos: m['photoMemos'] as String?,
    photoAspects: m['photoAspects'] as String?,
    photoFilters: m['photoFilters'] as String?,
    photoCrops: m['photoCrops'] as String?,
