...
class DiaryRepository {
  ...
  DiaryEntry _toDomain(DiaryEntryRow r) => DiaryEntry(
        ...
        tags: r.tags,
        pageCanvas: r.pageCanvas,
        flowPhotos: r.flowPhotos,
        photoFrames: r.photoFrames,
        photoStickers: r.photoStickers,
        photoTapes: r.photoTapes,
        photoMemos: r.photoMemos,
        photoAspects: r.photoAspects,
        photoFilters: r.photoFilters,
        photoCrops: r.photoCrops,
  ...
  DiaryEntriesCompanion _toCompanion(DiaryEntry e) => DiaryEntriesCompanion(
        ...
        contentRich: Value(e.contentRich),
        ...
        pageCanvas: Value(e.pageCanvas),
        flowPhotos: Value(e.flowPhotos),
        photoFrames: Value(e.photoFrames),
        photoStickers: Value(e.photoStickers),
        photoTapes: Value(e.photoTapes),
        photoMemos: Value(e.photoMemos),
        photoAspects: Value(e.photoAspects),
        photoFilters: Value(e.photoFilters),
        photoCrops: Value(e.photoCrops),
