...
/// decorative frame for it, long-press to pick a sticker, tap the ✕ badge to
/// remove it. Owns the picker sheets itself (needs a BuildContext) and
/// reports results up via [onFramePicked]/[onStickerPicked] so WriteScreen
/// only has to call setState. Extracted from WriteScreen's build() to keep
/// that file under the size limit (see write_widgets.dart / write_deco_tile.dart
        ...
        itemBuilder: (_, i) => Stack(
          children: [
            GestureDetector(
              ...
              onLongPress: () => _pickSticker(context, i),
              child: FramedPhoto(
                photoPaths[i],
