...
- 글자넣기(텍스트 레이어): 글꼴 4종, 글자크기 프리셋, 자간 프리셋
...
| **글자넣기(텍스트 레이어) 리치텍스트** | 텍스트박스는 완료, 글자넣기는 폰트/크기/자간만 있고 굵게/기울임/색상 등 인라인 서식 없음 |
...
1. **글자넣기 리치텍스트** — 텍스트박스와 동일한 인라인 서식(굵게/색상 등)을 글자넣기(텍스트 레이어)에도 확장 → 두 텍스트 편집 경로 일관성 확보 (작고 검증 가능, 자율 루프 적합)
